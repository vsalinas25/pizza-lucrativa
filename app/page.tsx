  ...
  return (
    <main className="min-h-screen">
      ...
      <section className="relative px-5 pt-10 pb-8 sm:px-8 sm:pt-16">
        <p className="font-mono text-xs uppercase tracking-[0.2em] text-brasa-400 mb-3">
          Para donos de pizzaria
        </p>
        <h1 className="font-display text-3xl sm:text-5xl font-semibold leading-[1.1] text-trigo-50 max-w-2xl">
          Você fatura bem. Mas nunca sabe exatamente{" "}
          <span className="text-brasa-400">quanto cada pizza deixa</span> no seu bolso.
        </h1>
        <p className="mt-4 text-trigo-400 text-base sm:text-lg max-w-xl">
        ...
        <div className="mt-5 sticky bottom-4 sm:static sm:mt-6 z-20">
          ...
          <p className="text-center text-xs text-trigo-400 mt-2">
      ...
      {/* DOR */}
      <section className="px-5 sm:px-8 py-10 border-t border-carvao-700">
        ...
        <ul className="space-y-4">
          {[
            ...
            <li key={dor} className="flex gap-3 items-start">
              <span className="mt-1 h-1.5 w-1.5 rounded-full bg-brasa-400 shrink-0" />
              <span className="text-trigo-200">{dor}</span>
            </li>
          ))}
        </ul>
      </section>
      ...
      {/* PROVA REAL */}
      <section className="px-5 sm:px-8 py-10 border-t border-carvao-700 bg-carvao-900">
        <p className="font-mono text-xs uppercase tracking-[0.2em] text-brasa-400 mb-2">
          Caso real
        </p>
        ...
        <div className="grid grid-cols-2 gap-4 sm:gap-6 max-w-md">
          <div className="rounded-lg bg-carvao-800 p-4">
            <p className="font-mono text-3xl font-semibold text-sinal-vermelho tabular-nums">
              44,56%
            </p>
            <p className="text-sm text-trigo-400 mt-1">CMV real identificado — bem acima do saudável</p>
          </div>
          <div className="rounded-lg bg-carvao-800 p-4">
            <p className="font-mono text-3xl font-semibold text-brasa-400 tabular-nums">2</p>
            <p className="text-sm text-trigo-400 mt-1">Canais com gap de precificação descoberto</p>
          </div>
        </div>
        <p className="text-trigo-200 mt-6 max-w-xl">
      ...
      <section className="px-5 sm:px-8 py-10 border-t border-carvao-700">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          {[
            ...
            <div key={item.t} className="rounded-lg border border-carvao-700 p-5">
              <h3 className="font-display text-lg font-semibold text-brasa-400 mb-1">{item.t}</h3>
              <p className="text-trigo-400 text-sm">{item.d}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="px-5 sm:px-8 py-10 border-t border-carvao-700 bg-carvao-900">
        ...
        <p className="text-trigo-400 mb-6">Menos que uma pizza grande por mês no primeiro ano.</p>
        <ul className="space-y-3 mb-6">
          {[
            ...
            <li key={i} className="flex gap-3 text-trigo-200">
              <span className="text-brasa-400">✓</span> {i}
            </li>
          ))}
        </ul>
        <div className="rounded-lg border border-brasa-500 p-5 mb-4">
          <p className="text-trigo-50 font-semibold">R$297 · pagamento único</p>
          <p className="text-trigo-400 text-sm mt-1">
            ...
            <strong className="text-trigo-200">
      ...
      {/* CTA FINAL */}
      <section className="px-5 sm:px-8 py-14 border-t border-carvao-700 text-center">
